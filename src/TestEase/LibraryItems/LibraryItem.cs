...
namespace TestEase.LibraryItems
{
    ...
    public class LibraryItem
    {
        ...
        ///     The file cannot be found, such as when <see cref="FileMode" /> is
        ///     FileMode.Truncate or FileMode.Open, and the file specified by path does not exist. The file must already exist in
        ///     these modes.
        /// </exception>
        ...
        ///     path, such as when <see cref="FileAccess" /> is Write or ReadWrite and the file or directory is set for read-only
        ///     access.
        /// </exception>
